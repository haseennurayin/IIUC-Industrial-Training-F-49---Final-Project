...
def get_category_id(connection, category):
    ...
    return c_result[0][0] if c_result else None
...
def get_reporter_id(connection, reporter):
    ...
    return r_result[0][0] if r_result else None
...
def get_publisher_id(connection, publisher):
    ...
    return p_result[0][0] if p_result else None
...
def get_news_id(connection, title):
    ...
    return n_result[0][0] if n_result else None
