...
fixed_bad_variable = 42  
snake_case_name = "variable names should use snake_case"
another_example = "examples for variable names"
my_age = 30  

print("Fixed bad variable:", fixed_bad_variable)
print("Good variable naming examples:")
print(snake_case_name, another_example, my_age)
...
dynamic_var = "I am a string"
print("Before reassignment:", dynamic_var)

dynamic_var = 123  
print("After reassignment:", dynamic_var)
