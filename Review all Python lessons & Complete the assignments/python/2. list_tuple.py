...
mixed_tuple = (24, "Haseen", 3.14, False)

tuple_key_dict = {
    mixed_tuple: "Sample Data"
}

value = tuple_key_dict[mixed_tuple]

print("Tuple:", mixed_tuple)
print("Dictionary value for the tuple key:", value)
...
# Creating a list of tuples with students' names and grades
...
students_sorted_by_grade = sorted(students, key=lambda student: student[1])
