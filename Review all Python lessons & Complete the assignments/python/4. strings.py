...
bio_data = "Name: Haseen Nurayin, Age: 24, Country: Bangladesh"

name = bio_data.split(",")[0].split(": ")[1]  
age = int(bio_data.split(",")[1].split(": ")[1])  
...
formatted_string = f"Hello, my name is {person_info['name']}, I'm {person_info['age']} years old, and I live in {person_info['country']}."
...
sample_string = "hello, haseen"
char_counts = char_count(sample_string)
